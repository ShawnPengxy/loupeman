library(reshape)
importdata<-`51637` 
importdata<-rename(importdata,c(MEASUREMENT="measurement",SHAPE="shape",CRTWT="carat", COL="color", CLR="clarity", CUT="cut", POL="polish",SYM="symmetry",FLOURESENCE="fluorescence",LAB="report",CERT_NO="reportno",Stock.NO="stoneid", RAP_DIS="back",RAP_RTE="rapprice",RTE="price"))
