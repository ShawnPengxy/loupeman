...
importdata<-rename(importdata, c(Remark="Remark",Shape="shape",Bal.Cts="carat", Color="color",Clarity="clarity",Cut="cut", Polish="polish", Symm="symmetry", Fluo.="fluorescence",Lab="report", Certificate.No="reportno", Lot.ID="stoneid",X....SC3="back", List="rapprice"))
...
Myvars<-c("Remark","shape","carat","color","clarity","cut","polish","symmetry","fluorescence","colsh","milky","green","measurement","report","reportno","rapnetid","stoneid","back","rapprice","price")
Fin<-OOPut[Myvars]
index_Fin<-Myvars%in%c("Remark")
Fin<-Fin[!index_Fin]
