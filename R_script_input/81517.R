...
importdata<-rename(importdata, c(DIAMETER="measurement",SH="shape",CT.="carat", COL="color",CLT="clarity",CUT="cut", PO="polish", SYM="symmetry", FLO="fluorescence",Lab="report", CERTIFICTE="reportno", M.ID="stoneid",FINAL="back",NEW.RAP="rapprice",N.AMT="price"))
