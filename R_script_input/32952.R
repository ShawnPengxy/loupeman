...
importdata<-rename(importdata, c(Shape="shape",Carat="carat", Color="color",Purity="clarity",Cut="cut", Polish="polish", Symm="symmetry", FL="fluorescence",Lab="report", CertiNo="reportno", PacketCode="stoneid", Off.="back", Rapaport="rapprice",Price="price"))
