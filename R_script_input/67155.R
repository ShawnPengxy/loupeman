...
library(reshape)
importdata<-`67155`
importdata<-rename(importdata,c(Milky="Milky",Brown="Brown",Tint="Tint", Shape="shape",Carats="carat", Color="color", Clarity="clarity", Cut="cut", Pol="polish",Sym="symmetry",Fluor="fluorescence",CERT="report",Certificate.No="reportno",STKID="stoneid", RapDis="back",RapRate="rapprice",Total.USD="price"))
